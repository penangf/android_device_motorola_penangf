...
BOARD_VENDOR_RAMDISK_KERNEL_MODULES := $(addprefix $(KERNEL_PATH)/vendor_boot-modules/, $(BOARD_VENDOR_RAMDISK_KERNEL_MODULES_LOAD))

## recovery modules
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := $(strip $(shell cat $(DEVICE_PATH)/modules.load.recovery))
RECOVERY_MODULES := $(addprefix $(KERNEL_PATH)/vendor_boot-modules/, $(BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD))
...
ODM_MANIFEST_SS_FILES := $(DEVICE_PATH)/vintf/sku/manifest_ss.xml
ODM_MANIFEST_TSTS_FILES := $(DEVICE_PATH)/vintf/sku/manifest_tsts.xml
ODM_MANIFEST_QSQS_FILES := $(DEVICE_PATH)/vintf/sku/manifest_qsqs.xml
ODM_MANIFEST_DSDS_FILES := $(DEVICE_PATH)/vintf/sku/manifest_dsds.xml
